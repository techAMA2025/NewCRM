  ...
  ({ value, onClick, placeholder, onClear }, ref) => (
    <div className="relative">
      <input
        ...
        readOnly
        className="block w-full pl-3 pr-10 py-2.5 text-sm border border-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 rounded-xl cursor-pointer hover:border-gray-600 transition-all duration-200 shadow-sm"
      />
