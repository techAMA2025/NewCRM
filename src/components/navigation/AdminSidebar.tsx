    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-950 text-white w-64 h-screen overflow-y-auto flex-shrink-0 py-6 shadow-xl">
      ...
      <nav className="mt-4">
        <ul className="space-y-1">
          ...
          <li>
            <Link href="/recovery" className={`flex items-center px-6 py-3 ${isActive('/recovery')} transition-all duration-200 hover:bg-gray-800/70 hover:text-indigo-400 group`}>
              <FaMoneyBillWave className="mr-3 text-gray-500 group-hover:text-indigo-400 transition-colors duration-200" />
              <span>Recovery</span>
            </Link>
          </li>
